                ...
                <motion.div
                    ...
                    <p
                        ...
                        style={{
                            ...
                            fontStyle: "italic",
                            fontSynthesisStyle: "auto"
                        }}>无论您有任何疑问或需求，我们的团队随时准备为您提供专业支持。</p>
                </motion.div>
                        ...
                        <div className="sticky top-24">
                            ...
                            <div className="space-y-6 mb-8">
                                <div className="flex items-start">
                                    <div
                                        className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 flex-shrink-0">
