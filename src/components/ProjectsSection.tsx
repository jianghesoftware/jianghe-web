  ...
  return (
    <section id="案例" className="py-20 bg-gray-900 text-white" ref={containerRef}>
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <span className="inline-block px-4 py-1 rounded-full bg-blue-900 text-blue-300 text-sm font-medium mb-3">
            成功案例
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                <span className="inline-block px-3 py-1 bg-blue-900 text-blue-300 text-xs rounded-full mb-3">
                  {project.category}
                </span>
                ...
                <a href="#" className="inline-flex items-center text-blue-400 font-medium group-hover:text-blue-300 transition-colors">
                  查看详情
        ...
        >
          <a href="#" className="inline-block border border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white px-8 py-3 rounded-lg transition-all duration-300">
            查看更多案例
          </a>
        </motion.div>
      </div>
